//
//  NSAttributedString+MKExtension.m
//  Zhifubao
//
...
#import "NSAttributedString+MKExtension.h"

@implementation NSAttributedString (MKExtension)

+ (instancetype)mk_imageTextWithImage:(UIImage *)image imageWH:(CGFloat)imageWH title:(NSString *)title fontSize:(CGFloat)fontSize titleColor:(UIColor *)titleColor spacing:(CGFloat)spacing {
